...
class TestResourceThumbnailDefault:
...
class TestResourceThumbnailString:
    ...
    def test_get_definition(self, registry_String):
        resource = registry_String.FuretUI.Resource.Thumbnail.insert(
...
class TestResourceThumbnailSequence:
    ...
    def test_get_definition(self, registry_Sequence):
        resource = registry_Sequence.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource', model='Model.Test', template='tmpl_test')
...
class TestResourceThumbnailPassword:
    ...
    def test_get_definition(self, registry_Password):
        resource = registry_Password.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource', model='Model.Test', template='tmpl_test')
...
class TestResourceThumbnailSelection:
    ...
    def test_get_definition(self, registry_Selection):
        resource = registry_Selection.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Test', template='tmpl_test')
...
class TestResourceThumbnailInteger:
    ...
    def test_get_definition(self, registry_Integer):
        resource = registry_Integer.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Test', template='tmpl_test')
...
class TestResourceThumbnailDateTime:
    ...
    def test_get_definition(self, registry_DateTime):
        resource = registry_DateTime.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Test', template='tmpl_test')
...
class TestResourceThumbnailMany2One:
        ...
        with TmpTemplate(registry) as tmpl:
            ...
            assert resource.get_definitions() == [{
                'body_template': (
                    ...
                    'null, "tags": ""}\' v-bind:resource="resource" '
                    'v-bind:data="data"></furet-ui-field>\n'
                    '                </div>\n'
                    '            '
                ),
        ...
        with TmpTemplate(registry) as tmpl:
            ...
            assert resource.get_definitions() == [{
                'body_template': (
                    ...
                    '"remote_columns": ["id"], "remote_name": '
                    f'"{remote_name}", '
                    '"resource": 4, "tags": ""}\' v-bind:resource="resource" '
                    'v-bind:data="data"></furet-ui-field>\n'
                    '                </div>\n'
                    '            '
                ),
    ...
    def test_get_definition_with_resource(self, registry_many2one):
        ...
        resource = registry.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Person', template='tmpl_test')
        resource_form = registry.FuretUI.Resource.Thumbnail.insert(
...
class TestResourceThumbnailMany2Many:
    ...
    def test_get_definition(self, registry_many2many):
        resource = registry_many2many.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Person', template='tmpl_test')
    ...
    def test_get_definition_with_resource(self, registry_many2many):
        resource = registry_many2many.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Person', template='tmpl_test')
        resource2 = registry_many2many.FuretUI.Resource.Form.insert(
            code='test-list-resource',
            model='Model.Person', template='tmpl_test')
        registry_many2many.IO.Mapping.set('resource_call', resource2)
        ...
        with TmpTemplate(registry_many2many) as tmpl:
            ...
            assert resource.get_definitions() == [{
                'body_template': (
                    ...
                    '"0", "writable": "0", "hidden": "0", "local_columns": '
                    '["name"], "remote_columns": ["id"], "remote_name": '
                    f'"persons", "resource": {resource2.id}'
                    '}\' v-bind:resource="resource" '
                    'v-bind:data="data"></furet-ui-field>\n'
                    '                </div>\n'
                    '            '
...
class TestResourceThumbnailOne2Many:
    ...
    def test_get_definition_with_resource(self, registry_one2many):
        ...
        resource = registry.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Address', template='tmpl_test')
        resource2 = registry.FuretUI.Resource.Form.insert(
            code='test-list-resource',
            model='Model.Address', template='tmpl_test')
        registry.IO.Mapping.set('resource_call', resource2)
        ...
        with TmpTemplate(registry) as tmpl:
            ...
            assert resource.get_definitions() == [{
                'body_template': (
                    ...
                    '"writable": "0", "hidden": "0", "local_columns": ["id"], '
                    f'"remote_columns": ["{", ".join(remote_columns)}"], '
                    f'"remote_name": "address", "resource": {resource2.id}'
                    '}\' v-bind:resource="resource" '
                    'v-bind:data="data"></furet-ui-field>\n'
                    '                </div>\n'
                    '            '
...
class TestResourceThumbnailOther:
    ...
    def test_get_definition_div(self, registry_with_buttons):
        resource = registry_with_buttons.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Test', template='tmpl_test')
...
class TestResourceRoles:
    ...
    def test_only_for_roles_1(self, registry_with_roles):
        resource = registry_with_roles.FuretUI.Resource.Thumbnail.insert(
            code='test-list-resource',
            model='Model.Test', template='tmpl_test')
